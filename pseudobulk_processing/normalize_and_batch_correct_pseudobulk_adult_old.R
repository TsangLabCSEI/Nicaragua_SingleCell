...
for (i in list.files("pseudobulk_aging_cohort/",pattern="adults")){
  cat(i,"-\n")
  path<-paste0("pseudobulk_aging_cohort/",i)
...
saveRDS(pseudobulk_list_normalized,"all_adult_pbulk_list_normalized.rds")
